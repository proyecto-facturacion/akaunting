...
return [
    ...
    'bill_recur_admin' => [
        ...
        'body'          => 'Witaj,<br /><br />Cykliczny rachunek <strong>{bill_number}</strong>  dla {vendor_name} została wygenerowana automatycznie.<br /><br />Szczegóły rachunku dostępne w poniższym linku: <a href="{bill_admin_link}">{bill_number}</a>.<br /><br />Pozdrawiamy,<br />{company_name}',
    ],
